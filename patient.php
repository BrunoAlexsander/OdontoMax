...
$crud = new Crud();
$res = $crud->selectDB("*", "patients", "WHERE id = '$patient_id'", array());
...
?>
                    ...
                    <div class="container-fluid">
						<div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Paciente / <?= $row['name']; ?></h1>
						</div>
						<div class="card shadow mb-4">
							...
							<div class="card-body">
                                <form method="POST" action="" name="editPatient">
                                    <div class="form-row">
                                    ...
                                    <a href="patients.php"><button type="button" class="btn btn-success">Voltar</button></a>
                                </form>
							</div>
						</div>
					</div>
