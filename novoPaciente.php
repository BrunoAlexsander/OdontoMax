...
if (isset($_POST['novoPaciente'])) {
    ...
    $sql = "INSERT INTO PACIENTE (NOME_PACIENTE, CPF, RG, NASCIMENTO, GENERO, EMAIL, CELULAR, TELEFONE, CEP, ENDERECO, NUMERO, BAIRRO, COMPLEMENTO, CIDADE, ESTADO) VALUES ('$nome', '$cpf', '$rg', '$nascimento', '$genero', '$email', '$celular', '$telefone', '$cep', '$endereco', '$numero', '$bairro', '$complemento', '$cidade', '$estado')";
...
<head>
    ...
    <title>OdontoMax - Novo paciente</title>
</head>
        ...
        <div class="row">
            <div class="col pt-3">
                <div class="alert alert-primary" role="alert">
                    Nessa página, você pode cadastrar um novo <a href="#" class="alert-link">paciente</a>. Sinta-se livre para adicionar novos pacientes.
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <form method="POST" action="">
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="inputNomePaciente" id="inputNomePaciente">
                </div>
                <div class="form-group col-md-4">
                    <label for="inputCPFPaciente">CPF:*</label>
                    <input type="text" class="form-control" name="inputCPFPaciente" id="inputCPFPaciente">
                </div>
                <div class="form-group col-md-4">
                    <label for="inputRGPaciente">RG:</label>
                    <input type="text" class="form-control" name="inputRGPaciente" id="inputRGPaciente">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-2">
                    <label for="inputNascimentoPaciente">Nascimento:*</label>
                    <input type="date" class="form-control" name="inputNascimentoPaciente" id="inputNascimentoPaciente">
                </div>
                <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="email" class="form-control" name="inputEmailPaciente" id="inputEmailPaciente">
                </div>
                <div class="form-group col-md-2">
                    <label for="inputCelularPaciente">Celular:*</label>
                    <input type="text" class="form-control" name="inputCelularPaciente" id="inputCelularPaciente">
                </div>
                <div class="form-group col-md-2">
                    <label for="inputTelefonePaciente">Telefone:</label>
                    <input type="text" class="form-control" name="inputTelefonePaciente" id="inputTelefonePaciente">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-4">
                    <label for="inputEnderecoPaciente">Endereço:*</label>
                    <input type="text" class="form-control" name="inputEnderecoPaciente" id="inputEnderecoPaciente">
                </div>
                <div class="form-group col-2">
                    <label for="inputNumeroPaciente">Número:*</label>
                    <input type="text" class="form-control" name="inputNumeroPaciente" id="inputNumeroPaciente">
                </div>
                <div class="form-group col-3">
                    <label for="inputComplementoPaciente">Complemento:</label>
                    <input type="text" class="form-control" name="inputComplementoPaciente" id="inputComplementoPaciente">
                </div>
                <div class="form-group col-3">
                    <label for="inputBairroPaciente">Bairro:*</label>
                    <input type="text" class="form-control" name="inputBairroPaciente" id="inputBairroPaciente">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputCidadePaciente">Cidade:*</label>
                    <input type="text" class="form-control" name="inputCidadePaciente" id="inputCidadePaciente">
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control" name="inputCEPPaciente" id="inputCEPPaciente">
                </div>
            </div>
            <button type="submit" class="btn btn-primary" name="novoPaciente" id="novoPaciente">Cadastrar</button>
