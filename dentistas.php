...
if (isset($_GET['excluir'])) {
    ...
    mysqli_query($conn, "DELETE FROM DENTISTA WHERE CODIGO_DENTISTA = ('$excluir')");
...
<head>
    ...
    <title>OdontoMax - Dentistas</title>
</head>
        ...
        <div class="row">
            <div class="col pt-3">
                <div class="alert alert-primary" role="alert">
                    Nessa página, você encontrará todos os <a href="#" class="alert-link">dentistas</a> cadastrados. Sinta-se livre para adicionar novos dentistas.
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col pb-3">
                <a href="novoDentista.php">
                    <button type="button" class="btn btn-primary">Novo dentista</button>
                </a>
            </div>
        </div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php if (!$row['CRO'] == "") echo $row['CRO'];
                            else echo "Indefinido"; ?></td>
                        <td><?php echo $row['CELULAR']; ?></td>
                        <td><?php echo $row['EMAIL']; ?></td>
                        <td><a href="dentista.php?id=<?php echo $row['CODIGO_DENTISTA']; ?>"><i class="far fa-eye"></i></a> <a href="dentistas.php?excluir=<?php echo $row['CODIGO_DENTISTA']; ?>"><i class="fas fa-trash-alt"></i></a></td>
                    </tr>
                <?php
                }
                ?>
